...
// core.register_node("redstone:pressure_plate_"..level, {
...
// 	action = function(pos)
// 		local power_level = 0
// 		local level = core.get_item_group(core.get_node(pos).name, "pressure_plate_on")
// 		--detect players
// 		for _,object in ipairs(core.get_objects_inside_radius(pos, 1.2)) do
...
// 			core.swap_node(pos,{name="redstone:pressure_plate_"..power_level})
// 			redstone.collect_info(pos)
// 		end
// 	end,
// }
