namespace hopper {
	...
	const directions = {
		[0]:{src:vector.create3d({x:0, y:1, z:0}),dst:vector.create3d({x:-1, y:0, z:0}},
	// 	[1]:{src:vector.create3d({x:0, y:1, z:0}),dst:vector.create3d({x:0, y:0, z:1}},
	// 	[2]:{src:vector.create3d({x:0, y:1, z:0}),dst:vector.create3d({x:1, y:0, z:0}},
	// 	[3]:{src:vector.create3d({x:0, y:1, z:0}),dst:vector.create3d({x:0, y:0, z:-1}},
	// 	[4]:{src:vector.create3d({x:0, y:0, z:1}),dst:vector.create3d({x:-1, y:0, z:0}},
	// 	[5]:{src:vector.create3d({x:0, y:0, z:1}),dst:vector.create3d({x:0, y:-1, z:0}},
	// 	[6]:{src:vector.create3d({x:0, y:0, z:1}),dst:vector.create3d({x:1, y:0, z:0}},
	// 	[7]:{src:vector.create3d({x:0, y:0, z:1}),dst:vector.create3d({x:0, y:1, z:0}},
	// 	[8]:{src:vector.create3d({x:0, y:0, z:-1}),dst:vector.create3d({x:-1, y:0, z:0}},
	// 	[9]:{src:vector.create3d({x:0, y:0, z:-1}),dst:vector.create3d({x:0, y:1, z:0}},
	// 	[10]:{src:vector.create3d({x:0, y:0, z:-1}),dst:vector.create3d({x:1, y:0, z:0}},
	// 	[11]:{src:vector.create3d({x:0, y:0, z:-1}),dst:vector.create3d({x:0, y:-1, z:0}},
	// 	[12]:{src:vector.create3d({x:1, y:0, z:0}),dst:vector.create3d({x:0, y:1, z:0}},
	// 	[13]:{src:vector.create3d({x:1, y:0, z:0}),dst:vector.create3d({x:0, y:0, z:1}},
	// 	[14]:{src:vector.create3d({x:1, y:0, z:0}),dst:vector.create3d({x:0, y:-1, z:0}},
	// 	[15]:{src:vector.create3d({x:1, y:0, z:0}),dst:vector.create3d({x:0, y:0, z:-1}},
	// 	[16]:{src:vector.create3d({x:-1, y:0, z:0}),dst:vector.create3d({x:0, y:-1, z:0}},
	// 	[17]:{src:vector.create3d({x:-1, y:0, z:0}),dst:vector.create3d({x:0, y:0, z:1}},
	// 	[18]:{src:vector.create3d({x:-1, y:0, z:0}),dst:vector.create3d({x:0, y:1, z:0}},
	// 	[19]:{src:vector.create3d({x:-1, y:0, z:0}),dst:vector.create3d({x:0, y:0, z:-1}},
	// 	[20]:{src:vector.create3d({x:0, y:-1, z:0}),dst:vector.create3d({x:1, y:0, z:0}},
	// 	[21]:{src:vector.create3d({x:0, y:-1, z:0}),dst:vector.create3d({x:0, y:0, z:1}},
	// 	[22]:{src:vector.create3d({x:0, y:-1, z:0}),dst:vector.create3d({x:-1, y:0, z:0}},
	// 	[23]:{src:vector.create3d({x:0, y:-1, z:0}),dst:vector.create3d({x:0, y:0, z:-1}},
	}
