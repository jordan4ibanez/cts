...
// core.register_node("redstone:space", {
//     description = "Stone",
//     tiles = {"stone.png"},
...
// 				data[p_pos] = core.get_content_id("main:stone")
// 			end
// 		end
// 		vm:set_data(data)
// 		vm:write_to_map()
...
// core.register_node("redstone:the_stone", {
...
// 				i.y = pos.y
// 				local p_pos = area:index(i.x,i.y,i.z)
// 				data[p_pos] = core.get_content_id("redstone:dust_0")
